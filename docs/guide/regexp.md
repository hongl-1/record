...
<table class="wikitable">
  <tbody>
    ...
    <tr>
      <th style="text-align:center;width: 200px">{<span style="font-family:Times New Roman; font-style:italic;">n</span>}</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">{<span style="font-family:Times New Roman; font-style:italic;">n</span>,<span style="font-family:Times New Roman; font-style:italic;">m</span>}</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">(pattern)</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">[a-z]</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\b</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\cx</th>
      <td>匹配由x指明的控制字符。例如，\cM匹配一个Control-M或回车符。x的值必须为A-Z或a-z之一。否则，将c视为一个原义的“<code>c</code>”字符。</td>
    </tr>
    <tr>
      <th style="text-align:center;width: 200px">\d</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\f</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\r</th>
      <td>匹配一个回车符。等价于\x0d和\cM。</td>
    </tr>
    <tr>
      <th style="text-align:center;width: 200px">\s</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\v</th>
      <td>匹配一个垂直制表符。等价于\x0b和\cK。</td>
    </tr>
    <tr>
      <th style="text-align:center;width: 200px">\w</th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\x<span style="font-family:Times New Roman; font-style:italic;">n</span></th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\<span style="font-family:Times New Roman; font-style:italic;">num</span></th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\<span style="font-family:Times New Roman; font-style:italic;">nm</span></th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\<span style="font-family:Times New Roman; font-style:italic;">nml</span></th>
    ...
    <tr>
      <th style="text-align:center;width: 200px">\u<span style="font-family:Times New Roman; font-style:italic;">n</span></th>
